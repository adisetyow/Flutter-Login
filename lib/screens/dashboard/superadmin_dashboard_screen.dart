...
class SuperAdminDashboardScreen extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            _buildFinanceSubMenus(context, isDarkMode),
  ...
  // Widget untuk menampilkan 4 sub menu
  Widget _buildFinanceSubMenus(BuildContext context, bool isDarkMode) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildSubMenuItem(
            context,
            Icons.report_gmailerrorred, // Ikon pengaduan
            'Pengaduan',
            Colors.red[600]!,
            '/pengaduan',
            isDarkMode,
          ...
          _buildSubMenuItem(
            context,
            Icons.savings, // Ganti dengan ikon "Jimpitan"
            'Jimpitan',
            Colors.orange[600]!,
            '/jimpitan',
            isDarkMode,
  ...
  // Widget untuk setiap item sub menu
  Widget _buildSubMenuItem(
    ...
    return InkWell(
      ...
      child: Container(
        width: 64, // Supaya tidak overflow
